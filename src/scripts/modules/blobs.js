    ...
    */
    var myModule = function () {
        ...
        var shapes = [
            ...
            { path: 'M52.165,8.622 C-3.182,25.082 -34.445,102.991 69.353,131.030 C173.152,159.067 264.199,96.310 262.989,53.179 C261.779,10.049 127.900,-13.899 52.165,8.622 Z', color: '#3f555e', size: [ 0.05, 0.085], position: [ 0.65, 3.6], scrollSpeed: 1.1 },
            { path: 'M992.275,441.058 C1157.959,-45.335 747.331,-52.144 356.494,60.890 C52.517,148.802 -17.442,266.939 3.409,422.809 C72.314,937.890 814.451,963.094 992.275,441.058 Z', color: '#a172f3', size: [ 0.4, 0.4], position: [ 0.6,  3.1], scrollSpeed: 0.9 },

            // Contact
            { path: 'M992.275,441.059 C1157.959,-45.335 747.331,-52.143 356.494,60.890 C52.517,148.803 -17.442,266.939 3.409,422.810 C72.314,937.890 814.451,963.094 992.275,441.059 Z', color: '#f92b27', size: [ 0.325, 0.4], position: [ 0.53,  4.42], scrollSpeed: 0.75 },
            { path: 'M34.046,729.082 C235.897,1334.608 995.948,1519.605 1596.445,1452.279 C2250.954,1378.899 2810.577,901.647 2682.000,601.000 C2390.905,-79.658 -328.624,-358.885 34.046,729.082 Z', color: '#eaeaea', size: [ 0.8, 0.7], position: [ 0.45,  3.3], scrollSpeed: 0.5 }
        ];
        var scene;
        var view;
        var Point;
