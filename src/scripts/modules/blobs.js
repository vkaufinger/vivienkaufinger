    ...
    var myModule = function () {
        ...
        function dataShapes () {
            ...
            shapes = [
                ...
                // Projects
                { path: 'M4.669,164.583 C21.259,220.635 153.569,285.238 228.003,208.398 C302.437,131.559 211.213,22.220 133.650,2.565 C56.087,-17.089 -18.030,87.882 4.669,164.583 Z', color: '#fc6964', size: [vw * 0.08, vh * 0.15], position: [vw * 0.26, vh * 2.75], scrollSpeed: 1.75 },
                { path: 'M52.165,8.622 C-3.182,25.082 -34.445,102.991 69.353,131.030 C173.152,159.067 264.199,96.310 262.989,53.179 C261.779,10.049 127.900,-13.899 52.165,8.622 Z', color: '#3f555e', size: [vw * 0.05, vh * 0.085], position: [vw * 0.65, vh * 5.3], scrollSpeed: 1.75 },
                { path: 'M992.275,441.058 C1157.959,-45.335 747.331,-52.144 356.494,60.890 C52.517,148.802 -17.442,266.939 3.409,422.809 C72.314,937.890 814.451,963.094 992.275,441.058 Z', color: '#a172f3', size: [vw * 0.4, vh * 0.4], position: [vw * 0.6,  vh * 4.1], scrollSpeed: 1.25 }
            ];
        }
